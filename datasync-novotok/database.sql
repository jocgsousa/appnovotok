...
CREATE TABLE IF NOT EXISTS meta_loja_vendedoras (
    ...
    percentual_comissao_venda_total DECIMAL(5,2) NOT NULL DEFAULT 0,
    valor_comissao_venda_total DECIMAL(15,2) NOT NULL DEFAULT 0,
    percentual_comissao_profissional_parceiras DECIMAL(5,2) NOT NULL DEFAULT 0,
    valor_comissao_profissional_parceiras DECIMAL(15,2) NOT NULL DEFAULT 0,
    valor_comissao_total DECIMAL(15,2) NOT NULL DEFAULT 0,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (meta_loja_id) REFERENCES metas_lojas(id) ON DELETE CASCADE
);
...
-- Pedidos de Vendas (capa do pedido)
CREATE TABLE IF NOT EXISTS `pedidos_vendas` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `numped` VARCHAR(20) NOT NULL,
  `recarga` CHAR(1) DEFAULT NULL,
  `dtentrega` DATE DEFAULT NULL,
  `tempo_hora` DECIMAL(18,4) DEFAULT NULL,
  `cl_tempo_total` VARCHAR(8) DEFAULT NULL,
  `numpedcli` VARCHAR(50) DEFAULT NULL,
  `numitens` INT DEFAULT NULL,
  `recebido` CHAR(1) DEFAULT NULL,
  `endercom` VARCHAR(255) DEFAULT NULL,
  `fantasia` VARCHAR(255) DEFAULT NULL,
  `codusur2` VARCHAR(20) DEFAULT NULL,
  `rca2` VARCHAR(100) DEFAULT NULL,
  `codcidade` INT DEFAULT NULL,
  `nomecidade` VARCHAR(100) DEFAULT NULL,
  `codpraca` INT DEFAULT NULL,
  `praca` VARCHAR(100) DEFAULT NULL,
  `enderent` VARCHAR(255) DEFAULT NULL,
  `cgcent` VARCHAR(20) DEFAULT NULL,
  `pontorefer` VARCHAR(255) DEFAULT NULL,
  `codfornecfrete` INT DEFAULT NULL,
  `numseqentrega` INT DEFAULT NULL,
  `codfornecredespacho` INT DEFAULT NULL,
  `codfuncajud` INT DEFAULT NULL,
  `forneccfrete` VARCHAR(100) DEFAULT NULL,
  `fornecdespacho` VARCHAR(100) DEFAULT NULL,
  `fretedespacho` VARCHAR(20) DEFAULT NULL,
  `dtexportacao` DATETIME DEFAULT NULL,
  `dtimportacao` DATETIME DEFAULT NULL,
  `numviasmapasep` INT DEFAULT NULL,
  `numpedrca` VARCHAR(50) DEFAULT NULL,
  `codfilial` VARCHAR(20) DEFAULT NULL,
  `codfilialnf` VARCHAR(20) DEFAULT NULL,
  `condvenda` INT DEFAULT NULL,
  ...
  `estent` VARCHAR(2) DEFAULT NULL,
  `vltotal` DECIMAL(15,2) DEFAULT NULL,
  `vlatend` DECIMAL(15,2) DEFAULT NULL,
  `codusur` VARCHAR(20) DEFAULT NULL,
  `numcar` VARCHAR(20) DEFAULT NULL,
  `nome` VARCHAR(100) DEFAULT NULL,
  `codeemitente` INT DEFAULT NULL,
  `codfunclibera` INT DEFAULT NULL,
  `codfuncconf` INT DEFAULT NULL,
  `codplpag` INT DEFAULT NULL,
  `descricao` VARCHAR(100) DEFAULT NULL,
  `prazo1` INT DEFAULT NULL,
  `prazo2` INT DEFAULT NULL,
  `prazo3` INT DEFAULT NULL,
  `prazo4` INT DEFAULT NULL,
  `prazo5` INT DEFAULT NULL,
  `prazo6` INT DEFAULT NULL,
  `prazo7` INT DEFAULT NULL,
  `prazo8` INT DEFAULT NULL,
  `prazo9` INT DEFAULT NULL,
  `prazo10` INT DEFAULT NULL,
  `prazo11` INT DEFAULT NULL,
  `prazo12` INT DEFAULT NULL,
  ...
  `codcob` VARCHAR(20) DEFAULT NULL,
  `numtransvenda` BIGINT DEFAULT NULL,
  `dtfat` DATE DEFAULT NULL,
  `horafat` INT DEFAULT NULL,
  `minutofat` INT DEFAULT NULL,
  `horamon` INT DEFAULT NULL,
  `minutomon` INT DEFAULT NULL,
  `dtlibera` DATE DEFAULT NULL,
  `motivoposicao` VARCHAR(255) DEFAULT NULL,
  `perclucro` DECIMAL(10,2) DEFAULT NULL,
  `horalib` VARCHAR(8) DEFAULT NULL,
  `numpedtv3` VARCHAR(50) DEFAULT NULL,
  `codclinf` VARCHAR(20) DEFAULT NULL,
  `origemped` VARCHAR(1) DEFAULT NULL,
  `dtaberturapedpalm` DATE DEFAULT NULL,
  `dtfechamentopedpalm` DATE DEFAULT NULL,
  `vlentrada` DECIMAL(15,2) DEFAULT NULL,
  `numpedentfut` VARCHAR(50) DEFAULT NULL,
  `numpedweb` VARCHAR(50) DEFAULT NULL,
  `numpedmktplace` VARCHAR(50) DEFAULT NULL,
  `vldescontocupom` DECIMAL(15,2) DEFAULT NULL,
  `pagamento_aprovado_ciashop` CHAR(1) DEFAULT NULL,
  `vlbonific` DECIMAL(15,2) DEFAULT NULL,
  `nomeemitente` VARCHAR(100) DEFAULT NULL,
  `cmotorista` VARCHAR(100) DEFAULT NULL,
  `clnomefunclibera` VARCHAR(100) DEFAULT NULL,
  `clnomefuncconf` VARCHAR(100) DEFAULT NULL,
  `nomefuncajudante` VARCHAR(100) DEFAULT NULL,
  `ccodmotorista` INT DEFAULT NULL,
  `dtsaidacarreg` DATE DEFAULT NULL,
  `cplaca` VARCHAR(10) DEFAULT NULL,
  `cnumnota` VARCHAR(20) DEFAULT NULL,
  `totpeso` DECIMAL(10,2) DEFAULT NULL,
  `utilizavendaporembalagem` CHAR(1) DEFAULT NULL,
  `horacanc` CHAR(1) DEFAULT ' ',
  `vlfrete` DECIMAL(15,2) DEFAULT NULL,
  `tot_bonific` INT DEFAULT NULL,
  `aguardandosefaz` CHAR(1) DEFAULT NULL,
  `totvolume` INT DEFAULT NULL,
  `tipo_transferencia` INT DEFAULT NULL,
  `codigorastreiofretevenda` VARCHAR(100) DEFAULT NULL,
  `numcupom` VARCHAR(20) DEFAULT NULL,
  `numcaixa` INT DEFAULT 0,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_pedidos_vendas_numped` (`numped`),
  KEY `idx_pedidos_vendas_data` (`data`),
  KEY `idx_pedidos_vendas_codfilial` (`codfilial`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;


-- Produtos dos pedidos de vendas (itens)
CREATE TABLE IF NOT EXISTS `pedidos_vendas_produtos` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `numped` VARCHAR(20) NOT NULL,
  `numseq` INT NOT NULL,
  `vlipi` DECIMAL(15,2) DEFAULT NULL,
  `percipi` DECIMAL(10,2) DEFAULT NULL,
  `nbm` VARCHAR(50) DEFAULT NULL,
  `codprod` INT DEFAULT NULL,
  `descricao` VARCHAR(200) DEFAULT NULL,
  `codfab` VARCHAR(50) DEFAULT NULL,
  `codsec` INT DEFAULT NULL,
  `codepto` INT DEFAULT NULL,
  `codcategoria` INT DEFAULT NULL,
  `secao` VARCHAR(100) DEFAULT NULL,
  `departamento` VARCHAR(100) DEFAULT NULL,
  `categoria` VARCHAR(100) DEFAULT NULL,
  `numlote` VARCHAR(50) DEFAULT NULL,
  `codfuncsep` INT DEFAULT NULL,
  `separadopor` VARCHAR(100) DEFAULT NULL,
  `embalagem` VARCHAR(50) DEFAULT NULL,
  `qtunitemb` DECIMAL(15,4) DEFAULT NULL,
  `pvendaemb` DECIMAL(15,2) DEFAULT NULL,
  `qt` DECIMAL(15,4) DEFAULT NULL,
  `pvenda` DECIMAL(15,2) DEFAULT NULL,
  `subtotal` DECIMAL(15,2) DEFAULT NULL,
  `st` DECIMAL(15,2) DEFAULT NULL,
  `dtlanc` DATETIME DEFAULT NULL,
  `codfunclanc` INT DEFAULT NULL,
  `rotinalanc` VARCHAR(50) DEFAULT NULL,
  `codfuncultalter` INT DEFAULT NULL,
  `rotinaultlalter` VARCHAR(50) DEFAULT NULL,
  `dtultlalter` DATETIME DEFAULT NULL,
  `perdesc` DECIMAL(10,2) DEFAULT NULL,
  `vldesc` DECIMAL(15,2) DEFAULT NULL,
  `codfilialretira` VARCHAR(20) DEFAULT NULL,
  `pliquido` DECIMAL(15,2) DEFAULT NULL,
  `horacanc` CHAR(1) DEFAULT ' ',
  `tipoentrega` VARCHAR(20) DEFAULT NULL,
  `original` DECIMAL(15,2) DEFAULT NULL,
  `precoriginal` DECIMAL(15,2) DEFAULT NULL,
  `codfornec` INT DEFAULT NULL,
  `fornecedor` VARCHAR(100) DEFAULT NULL,
  `codmarca` INT DEFAULT NULL,
  `marca` VARCHAR(100) DEFAULT NULL,
  `politicaprioritaria` VARCHAR(50) DEFAULT NULL,
  `campbrinde` INT DEFAULT NULL,
  `codauxiliar` VARCHAR(20) DEFAULT NULL,
  `percom` DECIMAL(10,2) DEFAULT NULL,
  `bonific` CHAR(1) DEFAULT NULL,
  `codigobrinde` INT DEFAULT NULL,
  `precomaxconsum` DECIMAL(15,2) DEFAULT NULL,
  `perbonific` DECIMAL(10,2) DEFAULT NULL,
  `perdesccom` DECIMAL(10,2) DEFAULT NULL,
  `descprecofab` DECIMAL(15,2) DEFAULT NULL,
  `descricao7` VARCHAR(200) DEFAULT NULL,
  `codusur` VARCHAR(20) DEFAULT NULL,
  `nome` VARCHAR(100) DEFAULT NULL,
  `codsupervisor` INT DEFAULT NULL,
  `nomesupervisor` VARCHAR(100) DEFAULT NULL,
  `qtbloqueada` DECIMAL(15,4) DEFAULT NULL,
  `vlbonific` DECIMAL(15,2) DEFAULT NULL,
  `numpedcli` VARCHAR(50) DEFAULT NULL,
  `numitemped` INT DEFAULT NULL,
  `coddeposito` INT DEFAULT NULL,
  `deposito` VARCHAR(100) DEFAULT NULL,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_pedidos_vendas_produtos_numped_numseq` (`numped`,`numseq`),
  KEY `idx_pedidos_vendas_produtos_numped` (`numped`),
  KEY `idx_pedidos_vendas_produtos_codprod` (`codprod`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Normalização para evitar duplicatas por espaços em `numped`
DROP TRIGGER IF EXISTS trg_pedidos_vendas_bi_trim;
CREATE TRIGGER trg_pedidos_vendas_bi_trim BEFORE INSERT ON pedidos_vendas
FOR EACH ROW SET NEW.numped = TRIM(NEW.numped), NEW.codfilial = TRIM(NEW.codfilial);

DROP TRIGGER IF EXISTS trg_pedidos_vendas_bu_trim;
CREATE TRIGGER trg_pedidos_vendas_bu_trim BEFORE UPDATE ON pedidos_vendas
FOR EACH ROW SET NEW.numped = TRIM(NEW.numped), NEW.codfilial = TRIM(NEW.codfilial);

DROP TRIGGER IF EXISTS trg_pedidos_vendas_produtos_bi_trim;
CREATE TRIGGER trg_pedidos_vendas_produtos_bi_trim BEFORE INSERT ON pedidos_vendas_produtos
FOR EACH ROW SET NEW.numped = TRIM(NEW.numped);

DROP TRIGGER IF EXISTS trg_pedidos_vendas_produtos_bu_trim;
CREATE TRIGGER trg_pedidos_vendas_produtos_bu_trim BEFORE UPDATE ON pedidos_vendas_produtos
FOR EACH ROW SET NEW.numped = TRIM(NEW.numped);